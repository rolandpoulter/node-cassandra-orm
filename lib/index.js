var Connection = exports.Connection = require('./Connection'),
    ...
    helenus = exports.ConsistencyLevel = require('helenus').ConsistencyLevel;
...
exports.connect = function (options, callback) {
  ...
  return exports.connection = new Connection(options, function (err) {
    if (typeof callback === 'function') callback(err, err ? undefined : exports.connection);
    ...
    if (err) {
      ...
      exports.events.forever('ready', exports.connection);
...
exports.define =
exports.describe = function (name, desc, proc, postPonePrepare) {
  return exports.models[name] = new Model(name, desc, proc, postPonePrepare);
};
